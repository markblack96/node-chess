/*
 * I took this pretty shamelessly from boardgame.io examples to hastily
 * replace a deprecated third party component.
 * https://github.com/boardgameio/boardgame.io/blob/master/examples/react-web/src/chess/grid.js
 */
 ...
 *  onMouseOver - (x, y) => {}
 *                Called when a square is moused over.
 *  onMouseOut  - (x, y) => {}
 *                Called when a square is moused out.
 * 
 * Usage:
 * <Grid rows={8} cols={8}>
 *  <Token x={1} y={2}
    ...
    render() {
        const tokens = React.Children.map(this.props.children, child => {
            return React.cloneElement(child, {
                template: Square,
                // overwrites token's onclick, onmouse, onmouseout
                onClick: this.onClick,
                onMouseOver: this.onMouseOver,
                onMouseOut: this.onMouseOut,
                svgRef: this._svgRef,
